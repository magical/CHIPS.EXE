...
Seven:
    ...
    %define uninitializedY (bp-0x12)
    %define uninitializedX (bp-0x14)
    %define tmp (bp-0x1a)
...
.label29: ; 13ee
    ...
    jnz .label30
    push byte +0x8
    call word 0x154f:0xcbe ; 1433 2:cbe
    add sp,byte +0x2
...
.label54: ; 1774
    ...
    jz .label61
    mov si,[uninitializedY]
    shl si,byte 0x5
    add si,[uninitializedX]
    mov bx,[GameStatePtr]
    mov al,[bx+si+Lower]
    sub ah,ah
    sub ax,ToggleButton
...
.label63: ; 17ae
    push byte +0x0
    push word [uninitializedY]
    push word [uninitializedX]
    push word [hDC]
