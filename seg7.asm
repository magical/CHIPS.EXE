...
.label0: ; 24
    mov bx,[GameStatePtr]
    cmp word [bx+0x80c],byte +0x0 ; isSliding
    jz .label2
    jmp word .label3
.label2: ; 32
...
.label10: ; 39
    ...
    jmp word .label3
.label4: ; 46
    cmp word [bx+0x80e],byte +0x0 ; isBuffered
    jz .label5
    cmp word [bx+Autopsy],byte +0x0 ; autopsy
    jnz .label6
    push byte +0x1
    push byte +0x1
    push word [bx+0x814]
...
.label38: ; 5a6
    push word [bp-0xa]
    call word 0x6a7:0x13de ; 5a9
    add sp,byte +0x2
    push word [0x12]
    push word [bp-0xa]
    call word 0x0:0xffff ; 5b8
    ...
    push byte +0x1
    push byte +0xd
    call word 0x607:0x56c ; 5e7
    add sp,byte +0x4
.label71: ; 5ef
    push byte +0x1
    call word 0x619:0xcbe ; 5f1
    add sp,byte +0x2
    cmp word [0x1694],byte +0x0
    jnz .label70
    push byte +0x1
    push byte +0xe
    call word 0xffff:0x56c ; 604
    add sp,byte +0x4
    mov bx,[GameStatePtr]
    mov word [bx+Autopsy],0x6
    call word 0x24e:0xb9a ; 616
    push byte +0x1
    mov bx,[GameStatePtr]
    push word [bx+0x800]
    call word 0xffff:0x356 ; 625
    add sp,byte +0x4
.label70: ; 62d
    pop si
    pop di
